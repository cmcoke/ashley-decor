    ...
    <div id="review_form">
      <?php
        ...
        foreach ($fields as $key => $field) {
          ...
          $field_html .= '<input id="' . esc_attr($key) . '" name="' . esc_attr($key) . '" type="' . esc_attr($field['type']) . '" value="' . esc_attr($field['value']) . '" size="30" ' . ($field['required'] ? 'required' : '') . ' class="w-full border-gray-300 p-3 rounded-md focus:ring-theme-orange focus:border-theme-orange" /></p>';
        ...
        if (wc_review_ratings_enabled()) {
          $comment_form['comment_field'] = '<div class="comment-form-rating mb-6"><label for="rating" class="block text-sm font-bold uppercase mb-2">' . esc_html__('Your rating', 'woocommerce') . (wc_review_ratings_required() ? ' <span class="required">*</span>' : '') . '</label><select name="rating" id="rating" required>
        ...
        $comment_form['comment_field'] .= '<p class="comment-form-comment mb-6"><label for="comment" class="block text-sm font-bold uppercase mb-2">' . esc_html__('Your review', 'woocommerce') . ' <span class="required">*</span></label><textarea id="comment" name="comment" cols="45" rows="8" required class="w-full border-gray-300 p-3 rounded-md focus:ring-theme-orange focus:border-theme-orange"></textarea></p>';
